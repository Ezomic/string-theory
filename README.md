...
Live at **https://string-theory.thijssensoftware.nl** ([ST-39](https://tracker.thijssensoftware.nl/issues/ST-39)).
...
### Post-Milestone-6 — Fretboard quiz per-string accuracy breakdown ([ST-9](https://tracker.thijssensoftware.nl/issues/ST-9))
...
### Post-Milestone-6 — Tuner usage instrumentation + Tuned 50× achievement ([ST-11](https://tracker.thijssensoftware.nl/issues/ST-11))
...
### Post-Milestone-6 — Real daily reminder notifications ([ST-12](https://tracker.thijssensoftware.nl/issues/ST-12))
...
### Post-Milestone-6 — Wired the global notation-labels setting, added solfège ([ST-13](https://tracker.thijssensoftware.nl/issues/ST-13))
...
### Post-Milestone-6 — Real local "Export practice data" ([ST-14](https://tracker.thijssensoftware.nl/issues/ST-14))
...
### Post-Milestone-6 — Mic permission now persists across navigation ([ST-15](https://tracker.thijssensoftware.nl/issues/ST-15))
...
### Post-Milestone-6 — Curriculum expanded from 5 to 15 lessons ([ST-16](https://tracker.thijssensoftware.nl/issues/ST-16))
...
### Post-Milestone-6 — Real chord-progression ear-training generator ([ST-17](https://tracker.thijssensoftware.nl/issues/ST-17))
...
### Post-Milestone-6 — Lesson See step now follows the learner's actual instrument ([ST-18](https://tracker.thijssensoftware.nl/issues/ST-18))
...
### Post-Milestone-6 — Left-handed setting now actually mirrors the fretboard ([ST-19](https://tracker.thijssensoftware.nl/issues/ST-19))
...
correct for guitar.
### Post-Milestone-6 — Reconciled lesson progress after curriculum growth ([ST-20](https://tracker.thijssensoftware.nl/issues/ST-20))
...
### Post-Milestone-6 — Daily Mix's weak spot can now be an ear-training skill ([ST-21](https://tracker.thijssensoftware.nl/issues/ST-21))
...
### Post-Milestone-6 — Play exercises catalog expanded from 6 to 10 ([ST-22](https://tracker.thijssensoftware.nl/issues/ST-22))
...
### Post-Milestone-6 — Retaking placement no longer destroys real lesson progress ([ST-23](https://tracker.thijssensoftware.nl/issues/ST-23))
...
### Post-Milestone-6 — Added the mockup's "Full unit" achievement ([ST-24](https://tracker.thijssensoftware.nl/issues/ST-24))
...
verification here is complete.
### Post-Milestone-6 — Registered 'progressions' in the shared skill metadata map, fixed ear-drill mastery always showing 0% ([ST-25](https://tracker.thijssensoftware.nl/issues/ST-25))
...
percentage.
### Post-Milestone-6 — Unlocked "Chord progressions" now appears in DrillPage's quick-switch pills ([ST-26](https://tracker.thijssensoftware.nl/issues/ST-26))
...
### Post-Milestone-6 — Microphone picker now updates the shared mic-permission store ([ST-27](https://tracker.thijssensoftware.nl/issues/ST-27))
...
permission prompt).
### Post-Milestone-6 — Scale-recognition ear drill now includes major/minor pentatonic ([ST-28](https://tracker.thijssensoftware.nl/issues/ST-28))
...
### Post-Milestone-6 — Tuner calibration now actually reaches the live pitch engine ([ST-29](https://tracker.thijssensoftware.nl/issues/ST-29))
...
### Post-Milestone-6 — Placement's "Chords & theory" result row now reads the right strength ([ST-30](https://tracker.thijssensoftware.nl/issues/ST-30))
...
### Post-Milestone-6 — Tuner's locked-string target resets when the tuning changes ([ST-31](https://tracker.thijssensoftware.nl/issues/ST-31))
...
### Post-Milestone-6 — Notation-labels setting now applies to Play & Feedback too ([ST-32](https://tracker.thijssensoftware.nl/issues/ST-32))
...
to its own root).
### Post-Milestone-6 — Added 'progressions' to Daily Mix's weak-spot icon map ([ST-33](https://tracker.thijssensoftware.nl/issues/ST-33))
...
### Post-Milestone-6 — Expanded the SCALES catalog with Dorian, Mixolydian, harmonic minor ([ST-34](https://tracker.thijssensoftware.nl/issues/ST-34))
